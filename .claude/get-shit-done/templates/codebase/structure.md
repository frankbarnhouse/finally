...
- Usage: Reference from command with `@/Users/frankbarnhouse/Projects/udemy_finally/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/frankbarnhouse/Projects/udemy_finally/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/frankbarnhouse/Projects/udemy_finally/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
